...
create table sungby(
album_ID varchar2(4) constraint fk4 references album(album_ID),
...
REM: Studio Name is primary key so duplicate is not allowed
insert into studio values('Le studio','palani','7896452123');
...
insert into artist values('a001','shreya');
insert into artist values('a002','sid sriram');

REM: Artist Name is unique key so it's value must be unique otherwise it will diplay error
insert into artist values('a003','shreya');
...
insert into artist values('a003','anirudh');
